# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/00_builder.ipynb (unless otherwise specified).

__all__ = ['COUNTRIES_URL', 'USER_DIR', 'box_from_ul_lr_coords', 'ben_s2_patch_to_gdf', 'ben_s1_patch_to_gdf',
